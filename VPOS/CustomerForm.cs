...
namespace VPOS
{
    public partial class CustomerForm : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                // DentalDialog form1 = new DentalDialog(item.Text, CustomerID);
        ...
        public void LoadData()
        {
            ...
            foreach (Customer transactor in Global.customer)
            {
        ...
        private void dtGrid_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Customer _transactor = new Customer(updateID, dtGrid.Rows[e.RowIndex].Cells["name"].Value.ToString(), dtGrid.Rows[e.RowIndex].Cells["contact"].Value.ToString(), dtGrid.Rows[e.RowIndex].Cells["image"].Value.ToString(), dtGrid.Rows[e.RowIndex].Cells["address"].Value.ToString(), DateTime.Now.ToString("dd-MM-yyyy H:mm:ss"), Helper.OrgID);
            DBConnect.Update(_transactor, updateID);
            Global.customer.RemoveAll(x => x.Id == updateID);
